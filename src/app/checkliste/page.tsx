                    ...
                    {task.whiteboardUrl && (
                      <>
                        ...
                        <div className="w-full mt-1 text-xs text-blue-700 bg-blue-50 border border-blue-200 rounded-lg p-3 flex items-start gap-2">
                          ...
                          <span>
                            <strong>Ablage-Hinweis:</strong> Bitte keine Ordner erstellen – Dateien und Links mit beschreibendem Titel ablegen. Schema: <em>tiername-to-teach-themenbereich-aufgabeninhalt</em> (z.B. «nilpferd-to-teach-berufswelt-einsteigen-dialoge»).
                          </span>
                        </div>
                      </>
                    )}
